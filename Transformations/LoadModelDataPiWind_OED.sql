...
INSERT [dbo].[Model] ([ModelID], [ModelName], [ModelFamilyID], [ModelDescription], [VersionRef], [ReleaseDate], [Contact], [ModelTypeId], [Deleted]) 
		VALUES (@ModelId, N'PiWind OED', @ModelFamilyId, N'PiWind', N'1.0', N'Jun 2017', N'', 1, 0)
...
INSERT [dbo].[OasisSystem] ([OasisSystemID], [OasisSystemName], [OasisSystemDescription], [url], [Port], [SysConfigID]) 
		VALUES (@OasisSystemId, N'PiWind Oasis Mid Tier', N'PiWind Oasis Mid Tier', N'10.10.0.163', 9003, 4)  
INSERT [dbo].[OasisSystem] ([OasisSystemID], [OasisSystemName], [OasisSystemDescription], [url], [Port], [SysConfigID])  
		VALUES (@OasisSystemId+1, N'PiWind API', N'PiWind Lookup Service', N'http://10.10.0.163:9004/OasisLMF/PiWind/0.0.0.1/get_keys', 9004, NULL)
...
-------------insert data------------------------
--Transform
Insert Into Transform Values (@TransformId,'OED Source to Canonical','Source AccLoc to Canonical for PiWind',1)
Insert Into Transform Values (@TransformId+1,'OED Canonical to Model','Canonical to Model for PiWind',2)
...
INSERT [dbo].[File] ([FileId], [FileName], [FileDesc], [SourceID], [OwnerID], [LocationID], [DateTimeCreated], [DateTimeUpdated], [DateTimeDeleted], [OwnerNameCreated], [OwnerNameUpdated], [OwnerNameDeleted], [FileTypeId]) VALUES (@ToLocAXSDFileID,		N'OED_CanLocA.xsd', N'Canonical Loc Validation File', 1, 1, 106, getdate(), getdate(), NULL, N'Sys', N'Sys', NULL, 109) --XSD2a
INSERT [dbo].[File] ([FileId], [FileName], [FileDesc], [SourceID], [OwnerID], [LocationID], [DateTimeCreated], [DateTimeUpdated], [DateTimeDeleted], [OwnerNameCreated], [OwnerNameUpdated], [OwnerNameDeleted], [FileTypeId]) VALUES (@ToLocBXSDFileID,		N'OED_CanLocB.xsd', N'Canonical Loc Profile File', 1, 1, 106, getdate(), getdate(), NULL, N'Sys', N'Sys', NULL, 109) --XSD2b
...
INSERT [dbo].[File] ([FileId], [FileName], [FileDesc], [SourceID], [OwnerID], [LocationID], [DateTimeCreated], [DateTimeUpdated], [DateTimeDeleted], [OwnerNameCreated], [OwnerNameUpdated], [OwnerNameDeleted], [FileTypeId]) VALUES (@ToAccAXSDFileID,		N'OED_CanAccA.xsd', N'Canonical Acc Validation File', 1, 1, 106, getdate(), getdate(), NULL, N'Sys', N'Sys', NULL, 109) --XSD5a
INSERT [dbo].[File] ([FileId], [FileName], [FileDesc], [SourceID], [OwnerID], [LocationID], [DateTimeCreated], [DateTimeUpdated], [DateTimeDeleted], [OwnerNameCreated], [OwnerNameUpdated], [OwnerNameDeleted], [FileTypeId]) VALUES (@ToAccBXSDFileID,		N'OED_CanAccB.xsd', N'Canonical Acc Profile File', 1, 1, 106, getdate(), getdate(), NULL, N'Sys', N'Sys', NULL, 109) --XSD5b
...
set @int=@int+1  insert into [ProfileElement] values (@int+@ProfileElementId,'LocNumber',@LocProfileId,5,0) 
set @int=@int+1  insert into [ProfileElement] values (@int+@ProfileElementId,'LocName',@LocProfileId,5,10) 
set @int=@int+1  insert into [ProfileElement] values (@int+@ProfileElementId,'LocGroup',@LocProfileId,5,0) 
...
set @int=@int+1  insert into [ProfileElement] values (@int+@ProfileElementId,'SubArea2',@LocProfileId,5,0) 
set @int=@int+1  insert into [ProfileElement] values (@int+@ProfileElementId,'SubArea',@LocProfileId,5,0) 
set @int=@int+1  insert into [ProfileElement] values (@int+@ProfileElementId,'LowResCresta',@LocProfileId,5,0) 
set @int=@int+1  insert into [ProfileElement] values (@int+@ProfileElementId,'HighResCresta',@LocProfileId,5,0) 
set @int=@int+1  insert into [ProfileElement] values (@int+@ProfileElementId,'AreaCode',@LocProfileId,5,0) 
...
set @int=@int+1  insert into [ProfileElement] values (@int+@ProfileElementId,'OtherTIV',@LocProfileId,5,2) set @int2=@int2+1INSERT [dbo].[ProfileValueDetail] ([ProfileValueDetailID], [ProfileElementID],[PerilID],[CoverageTypeID],[ElementDimensionID]) VALUES (@int2+@ProfileValueDetailID ,@int+@ProfileElementId,@ModelPerilId+1,@ModelCoverageTypeId+2,2)
set @int=@int+1  insert into [ProfileElement] values (@int+@ProfileElementId,'ContentsTIV',@LocProfileId,5,2) set @int2=@int2+1INSERT [dbo].[ProfileValueDetail] ([ProfileValueDetailID], [ProfileElementID],[PerilID],[CoverageTypeID],[ElementDimensionID]) VALUES (@int2+@ProfileValueDetailID ,@int+@ProfileElementId,@ModelPerilId+1,@ModelCoverageTypeId+3,3)
set @int=@int+1  insert into [ProfileElement] values (@int+@ProfileElementId,'BITIV',@LocProfileId,5,2) set @int2=@int2+1INSERT [dbo].[ProfileValueDetail] ([ProfileValueDetailID], [ProfileElementID],[PerilID],[CoverageTypeID],[ElementDimensionID]) VALUES (@int2+@ProfileValueDetailID ,@int+@ProfileElementId,@ModelPerilId+1,@ModelCoverageTypeId+4,4)
...
set @int=@int+1  insert into [ProfileElement] values (@int+@ProfileElementId,'CondTag',@LocProfileId,5,0) 
...
set @int=@int+1  insert into [ProfileElement] values (@int+@ProfileElementId,'LocDed2Other',@LocProfileId,14,16) set @int2=@int2+1INSERT [dbo].[ProfileValueDetail] ([ProfileValueDetailID], [ProfileElementID],[PerilID],[CoverageTypeID],[ElementDimensionID]) VALUES (@int2+@ProfileValueDetailID ,@int+@ProfileElementId,@ModelPerilId+1,@ModelCoverageTypeId+2,2)
...
set @int=@int+1  insert into [ProfileElement] values (@int+@ProfileElementId,'LocDed3Contents',@LocProfileId,14,16) set @int2=@int2+1INSERT [dbo].[ProfileValueDetail] ([ProfileValueDetailID], [ProfileElementID],[PerilID],[CoverageTypeID],[ElementDimensionID]) VALUES (@int2+@ProfileValueDetailID ,@int+@ProfileElementId,@ModelPerilId+1,@ModelCoverageTypeId+3,3)
...
set @int=@int+1  insert into [ProfileElement] values (@int+@ProfileElementId,'LocDed4BI',@LocProfileId,14,16) set @int2=@int2+1INSERT [dbo].[ProfileValueDetail] ([ProfileValueDetailID], [ProfileElementID],[PerilID],[CoverageTypeID],[ElementDimensionID]) VALUES (@int2+@ProfileValueDetailID ,@int+@ProfileElementId,@ModelPerilId+1,@ModelCoverageTypeId+4,4)
...
set @int=@int+1  insert into [ProfileElement] values (@int+@ProfileElementId,'LocLimit2Other',@LocProfileId,14,15) set @int2=@int2+1INSERT [dbo].[ProfileValueDetail] ([ProfileValueDetailID], [ProfileElementID],[PerilID],[CoverageTypeID],[ElementDimensionID]) VALUES (@int2+@ProfileValueDetailID ,@int+@ProfileElementId,@ModelPerilId+1,@ModelCoverageTypeId+2,2)
...
set @int=@int+1  insert into [ProfileElement] values (@int+@ProfileElementId,'LocLimit3Contents',@LocProfileId,14,15) set @int2=@int2+1INSERT [dbo].[ProfileValueDetail] ([ProfileValueDetailID], [ProfileElementID],[PerilID],[CoverageTypeID],[ElementDimensionID]) VALUES (@int2+@ProfileValueDetailID ,@int+@ProfileElementId,@ModelPerilId+1,@ModelCoverageTypeId+3,3)
set @int=@int+1  insert into [ProfileElement] values (@int+@ProfileElementId,'LocLimitCode4BI',@LocProfileId,14,0) 
set @int=@int+1  insert into [ProfileElement] values (@int+@ProfileElementId,'LocLimitType4BI',@LocProfileId,14,0) 
set @int=@int+1  insert into [ProfileElement] values (@int+@ProfileElementId,'LocLimit4BI',@LocProfileId,14,15) set @int2=@int2+1INSERT [dbo].[ProfileValueDetail] ([ProfileValueDetailID], [ProfileElementID],[PerilID],[CoverageTypeID],[ElementDimensionID]) VALUES (@int2+@ProfileValueDetailID ,@int+@ProfileElementId,@ModelPerilId+1,@ModelCoverageTypeId+4,4)
...
set @int=@int+1  insert into [ProfileElement] values (@int+@ProfileElementId,'AccDed6All',@AccProfileId,20,27) 
set @int=@int+1  insert into [ProfileElement] values (@int+@ProfileElementId,'AccMinDed6All',@AccProfileId,20,25) 
set @int=@int+1  insert into [ProfileElement] values (@int+@ProfileElementId,'AccMaxDed6All',@AccProfileId,20,26) 
...
set @int=@int+1  insert into [ProfileElement] values (@int+@ProfileElementId,'AccLimit6All',@AccProfileId,20,28) 
...
set @int=@int+1  insert into [ProfileElement] values (@int+@ProfileElementId,'PolDed6All',@AccProfileId,20,0) 
set @int=@int+1  insert into [ProfileElement] values (@int+@ProfileElementId,'PolMinDed6All',@AccProfileId,20,0) 
set @int=@int+1  insert into [ProfileElement] values (@int+@ProfileElementId,'PolMaxDed6All',@AccProfileId,20,0) 
...
set @int=@int+1  insert into [ProfileElement] values (@int+@ProfileElementId,'CondName',@AccProfileId,16,54) 
